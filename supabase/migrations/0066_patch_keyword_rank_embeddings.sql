-- migrate:up
-- ===========================================
-- 0066_patch_keyword_rank_embeddings.sql
-- Harden the keyword ranking RPC so it no longer references the deprecated
-- keywords.embedding column and always hydrates vectors from the shared
...
-- migrate:down
-- Restore the definition from migration 0065.
