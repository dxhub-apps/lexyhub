-- migrate:up
-- ============================================================================
-- DataForSEO K4K Metrics Enrichment Function
-- ============================================================================
--
-- Creates function to enrich keywords populated by DataForSEO K4K with
-- normalized metrics derived from extras.monthly_trend and
-- extras.dataforseo.competition.
--
-- This migration installs the enrichment function that computes:
-- - base_demand_index, competition_score, engagement_score
-- - trend_momentum, deseasoned_trend_momentum, seasonal_label
-- - adjusted_demand_index, ai_opportunity_score
-- ============================================================================
...
-- migrate:down
DROP FUNCTION IF EXISTS enrich_dataforseo_k4k_metrics;
